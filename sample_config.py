...
class Config(object):
    ...
    ALIVE_NAME = os.environ.get("aghrab", None)
    AUTONAME = os.environ.get("mitiaghrab", None)
    ...
    DB_URI = os.environ.get("postgres://vshtgqee:Jk6BZEMnt4MAIWQ8ZrW85R5sSgc1u85J@babar.db.elephantsql.com/vshtgqee", None)
    ...
    BOT_TOKEN = os.environ.get("5910828786:AAGk4kH0zYSiEFHmG2axeWf1wjGBdCk25ng or os.environ.get("BOT_TOKEN_BF_HER", None)
    BOT_USERNAME = None
    # get this value from http://www.timezoneconverter.com/cgi-bin/findzone.tzc
    TZ = os.environ.get("TZ", "Asia/Kolkata")
    # set this with required legend repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Mititeryaki/LEGENDBOT-1"
    )
